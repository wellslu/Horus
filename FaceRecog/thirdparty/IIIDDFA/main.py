...
"""
The pipeline of IIIDDFA prediction: given one image, predict the 3d face vertices, 68 landmarks and visualization.
...
if __name__ == '__main__':
    IMG_PATH = 'samples/puff_ob.jpg'
    parser = argparse.ArgumentParser(description='IIIDDFA inference pipeline')
    parser.add_argument('-f', '--files', nargs='+',
                        default=[IMG_PATH],
                        help='image files paths fed into network, single or multiple images')
    parser.add_argument('-m', '--mode', default='cpu', type=str,
                        help='gpu or cpu mode')
    parser.add_argument('--show_flg', default='true', type=str2bool,
