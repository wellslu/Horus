...
def eval_seq(opt, dataloader, data_type, result_filename, cid_png=None, save_dir=None, show_image=True, frame_rate=30):
    '''
    ...
    for path, img, img0 in dataloader:
        ...
        if show_image or save_dir is not None:
            online_im = vis.plot_tracking(img0, save_dir, cid_png, online_tlwhs, online_ids, sql, frame_id=frame_id,
